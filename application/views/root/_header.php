...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin-lte/css/AdminLTE.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Finance</b> Manager</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo ucwords($this->session->userdata('user')->image); ?>" class="img-circle" alt="User Image">
              </li>
              <!-- Menu Footer-->
